...
//LGE_START,2013-03-05,myungwon.kim,Using Fixed LPA Memory
...
fail:
	...
	//LGE_CHANGE, 2013-03-14, sungbo0.jung@lge.com, for escape Null Pointer Dereference
...
#else
	//LGE_END, 2013-03-14, sungbo0.jung@lge.com, for escape Null Pointer Dereference
	ion_unmap_kernel(lpa_buf[0].client, lpa_buf[0].handle);
	ion_free(lpa_buf[0].client, lpa_buf[0].handle);
	ion_client_destroy(lpa_buf[0].client);
#endif
...
//LGE_END  ,2013-03-05,myungwon.kim,Using Fixed LPA Memory
