...
static int msm_afe_open(struct snd_pcm_substream *substream)
{
	...
	if (!prtd->audio_client) {
		...
		/* LGE_CHANGE_S, woohyun.seok@lge.com
		 * Object 'prtd' was dereferenced after being freed by calling kfree
		 * WBT issue fixed. depends on CR.423196
		 * Original code : 	kfree(prtd);
