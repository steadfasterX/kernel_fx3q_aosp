...
//LGE_START,myunghee.kim, Disclose to prevent Missing first 1-2 seconds of song while listening, TD 54301
#if 0
//LGE_START,myungwon.kim,to Google Play's Tick Noise Remove
static int lpa_set_volume_nosync(unsigned volume);
static int pause_is_called = 0;
//LGE_END  ,myungwon.kim,to Google Play's Tick Noise Remove
#endif
...
//LGE_START,myunghee.kim, Disclose to prevent Missing first 1-2 seconds of song while listening, TD 54301
#if 0
//LGE_START,myungwon.kim,Gradual LPA Volume Increasing making out of order
    if(pause_is_called > 0 )
