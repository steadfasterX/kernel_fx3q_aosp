...
/* LGE_CHANGE_S VFE overflow recovery patch 2013-07-07 jinsang.yun@lge.com */
#if (1)
static atomic_t recovery_active;
static uint32_t recover_irq_mask0, recover_irq_mask1;
#endif
/* LGE_CHANGE_E VFE overflow recovery patch 2013-07-07 jinsang.yun@lge.com */
...
/*LGE_CHANGE_S, clear all interupts from GK, 2013-02-15, soojong.jin@lge.com */
...
/*LGE_CHANGE_E, clear all interupts from GK, 2013-02-15, soojong.jin@lge.com */
...
/*LGE_CHANGE_E, camera recovery from GK, 2013-02-15, soojong.jin@lge.com */
	...
	axi_clear_all_interrupts(axi_ctrl->share_ctrl); /*LGE_CHANGE_S, clear all interupts from GK, 2013-02-15, soojong.jin@lge.com */
