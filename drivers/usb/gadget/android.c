...
/* LGE_CHANGE - FIXME
 * Building fx3s_spr_us error for CONFIG_USB_G_LGE_ANDROID_AUTORUN Feature.
 * f_mass_storage.c
 * 2012-10-18, sungho.jung@lge.com
 */
...
static const char lge_vendor_name[] = "LGE";
	/* CONFIG_USB_G_LGE_ANDROID_STORAGE_NAME="Android Platform" */
...
#endif
/* LGE_CHANGE - FIXME LA 1.71. FC
 * 2012-11-13, sungho.jung@lge.com
 */
#if defined CONFIG_USB_G_LGE_ANDROID && defined CONFIG_LGE_PM
	if (dev->check_pif) {
		dev_info(dev->dev, "pif cable is plugged, not permitted\n");
...
/* LGE_CHANGE - FIXME LA 1.71. FC
 * 2012-11-13, sungho.jung@lge.com
 * SAMPLE : struct android_dev *dev = cdev_to_android_dev(cdev);
 */
#if defined CONFIG_USB_G_LGE_ANDROID && defined CONFIG_LGE_PM
	if (dev->check_pif) {
		dev_info(dev->dev, "pif cable is plugged, not permitted\n");
