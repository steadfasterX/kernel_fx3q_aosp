 ...
 * @buffer_lock:	lock protecting the tree of buffers  //CONFIG_MACH_LGE_L9II_COMMON
 * @lock:		rwsem protecting the tree of heaps and clients //CONFIG_MACH_LGE_L9II_COMMON
...
#if defined(CONFIG_MACH_LGE_L9II_COMMON) || defined(CONFIG_MACH_LGE_F6_VDF) || defined(CONFIG_MACH_LGE_FX3Q_TMUS)
