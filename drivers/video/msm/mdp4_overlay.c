...
/* LGE_CHANGE_S [james.jang@lge.com] 2012-09-17, merge MSM8930 ES5 */
#ifdef CONFIG_FB_MSM_DTV
		mdp4_dtv_base_swap(0, pipe);
#else
		mdp4_dtv_base_swap(pipe);
#endif
/* LGE_CHANGE_E [james.jang@lge.com] 2012-09-17 */
...
//LGE_CHANGE_S [koh.euije@lge.com] QE Issue #332631
#if defined(CONFIG_MACH_LGE_L9II_COMMON)
	/* LGE_CHANGE
...
#endif
//LGE_CHANGE_E [koh.euije@lge.com] QE Issue #332631
...
/* LGE_CHANGE */
#if 0 // def CONFIG_LGE_HIDDEN_RESET
	if (on_hidden_reset)
