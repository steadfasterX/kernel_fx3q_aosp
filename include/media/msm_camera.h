...
#define CFG_SET_SOC_AWB_LOCK_PARAMS   56	/*LGE_CHANGE_S, add soc awb lock, 2013-01-01, kwangsik83.kim@lge.com*/
#define CFG_SET_SOC_AEC_LOCK_PARAMS   57	/*LGE_CHANGE_S, add soc aec lock, 2013-01-01, kwangsik83.kim@lge.com*/
